...
public class HomeView extends View {
	...
	private HomeView() {
		...
		components.add(new XboxButton(new Rectangle(80, 40, 7, 14), "B", new Color(126, 0, 14), new Color(191, 0, 9), this));
		components.add(new XboxButton(new Rectangle(60, 40, 7, 14), "X", new Color(12, 45, 241), new Color(51, 100, 253), this));
